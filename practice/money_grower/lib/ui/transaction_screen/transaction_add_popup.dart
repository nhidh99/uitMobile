...
import 'package:loginapp/ui/transaction_screen/transaction_category_page.dart';
  ...
  Future submitTransaction() async {
    ...
    if (priceText.isEmpty || priceText == '0' || dateText.isEmpty || name.isEmpty) {
      ...
      final transaction = TransactionModel(
          null, name, note, isIncomeTransaction ? price : -price, date, curUser.uid);
      TransactionBloc().insertTransaction(transaction);
      UserModel.addTransactionChange(isIncomeTransaction ? price : -price);
      UserBloc().updateUser(UserModel(), UserModel().id);
